...
extension UIView {
    ...
    private func addShimmerView(_ view: UIView) {
        ...
        shimmerViewBackground.layer.borderWidth = view.layer.borderWidth
        shimmerViewBackground.layer.cornerRadius = view.layer.cornerRadius
        shimmerView.layer.masksToBounds = view.layer.masksToBounds
        shimmerView.layer.maskedCorners = view.layer.maskedCorners
        ...
        shimmerViewBackground.clipsToBounds = true
...
extension UIView {
    func enableShimmerForAllViews(){
        for item in subviews{
            if item.subviews.count > 1{
                item.enableShimmerForAllViews()
            }else{
                item.withShimmer = true
            }
        }
    }
}
